...
func (o *UpdateDriverBadRequest) WithPayload(payload *v1.ErrorOAIGen) *UpdateDriverBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update driver bad request response
func (o *UpdateDriverBadRequest) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
...
func (o *UpdateDriverNotFound) WithPayload(payload *v1.ErrorOAIGen) *UpdateDriverNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update driver not found response
func (o *UpdateDriverNotFound) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
...
func (o *UpdateDriverInternalServerError) WithPayload(payload *v1.ErrorOAIGen) *UpdateDriverInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update driver internal server error response
func (o *UpdateDriverInternalServerError) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
...
func (o *UpdateDriverDefault) WithPayload(payload *v1.ErrorOAIGen) *UpdateDriverDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update driver default response
func (o *UpdateDriverDefault) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
