...
type EmitEventOK struct {
	...
	/*
	  In: Body
	*/
	Payload *v1.EmissionOAIGen `json:"body,omitempty"`
}
...
func (o *EmitEventOK) WithPayload(payload *v1.EmissionOAIGen) *EmitEventOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the emit event o k response
func (o *EmitEventOK) SetPayload(payload *v1.EmissionOAIGen) {
	o.Payload = payload
}
...
func (o *EmitEventBadRequest) WithPayload(payload *v1.ErrorOAIGen) *EmitEventBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the emit event bad request response
func (o *EmitEventBadRequest) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
...
func (o *EmitEventUnauthorized) WithPayload(payload *v1.ErrorOAIGen) *EmitEventUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the emit event unauthorized response
func (o *EmitEventUnauthorized) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
...
func (o *EmitEventInternalServerError) WithPayload(payload *v1.ErrorOAIGen) *EmitEventInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the emit event internal server error response
func (o *EmitEventInternalServerError) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
...
func (o *EmitEventDefault) WithPayload(payload *v1.ErrorOAIGen) *EmitEventDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the emit event default response
func (o *EmitEventDefault) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
