...
func (o *GetSubscriptionsOK) WithPayload(payload []*v1.SubscriptionOAIGen) *GetSubscriptionsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get subscriptions o k response
func (o *GetSubscriptionsOK) SetPayload(payload []*v1.SubscriptionOAIGen) {
	o.Payload = payload
}
...
func (o *GetSubscriptionsOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	payload := o.Payload
	if payload == nil {
		payload = make([]*v1.SubscriptionOAIGen, 0, 50)
	}
...
func (o *GetSubscriptionsBadRequest) WithPayload(payload *v1.ErrorOAIGen) *GetSubscriptionsBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get subscriptions bad request response
func (o *GetSubscriptionsBadRequest) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
...
func (o *GetSubscriptionsInternalServerError) WithPayload(payload *v1.ErrorOAIGen) *GetSubscriptionsInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get subscriptions internal server error response
func (o *GetSubscriptionsInternalServerError) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
...
func (o *GetSubscriptionsDefault) WithPayload(payload *v1.ErrorOAIGen) *GetSubscriptionsDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get subscriptions default response
func (o *GetSubscriptionsDefault) SetPayload(payload *v1.ErrorOAIGen) {
	o.Payload = payload
}
