...
func (o *UpdateSubscriptionParams) WithBody(body *v1.SubscriptionOAIGen) *UpdateSubscriptionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update subscription params
func (o *UpdateSubscriptionParams) SetBody(body *v1.SubscriptionOAIGen) {
	o.Body = body
}
